...
# Group Mechanics to distinct values
# Select the column of interest
column = df['Mechanics']  # Replace 'your_column_name' with the name of the column
...
collection = db["mechanics"]  # replace "your_new_collection_name" with the name of your new collection
